<template>
  <div class="vega-view">
    ...
    <dialog-box :active="dialogBoxActive" :minWidth="dialog.minWidth">
...
const spec = ref(null as any);
const chart = ref({} as any);
const chartTags = ref([] as any[]);
const args = ref(null as any);
...
const shareableChartUri = computed(() => shareableChartUriFn(props.chartId));
...
const renderDialog = (title: string, type: string, minWidth = 40) => {
  dialog.value = {
    title,
    type,
    minWidth,
