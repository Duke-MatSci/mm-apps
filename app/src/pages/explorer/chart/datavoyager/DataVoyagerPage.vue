...
const voyagerSpec = ref(null as any);
const data = ref({ values: [] } as any);
...
// Methods
const loadChart = (chartUri: string) => store.dispatch('vega/loadChart', chartUri);
const setBaseSpec = (spec: any) => store.commit('vega/setBaseSpec', spec);
