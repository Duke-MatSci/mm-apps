            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/spreadsheet" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">upload_file</md-icon>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/stepper" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">workspaces</md-icon>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/sdd" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">done_outline</md-icon>
                  <span class="explorer_page-nav-card_text">Submit SDD</span>
                  <p class="md-layout-item_para md-layout-item_para_fl">
                    Submit tidy data files that use a semantic data dictionary (SDD).
                  </p>
                </div>
              </router-link>
            </div>
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/xml" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">upload</md-icon>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/chart/editor/new" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">ssid_chart</md-icon>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/validList/all" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">manage_search</md-icon>
            ...
            <div class="md-layout-item md-layout-item_card">
              <router-link to="/explorer/curate/validList" v-slot="{ navigate, href }" custom>
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">note_add</md-icon>
            ...
            <div class="md-layout-item md-layout-item_card">
              ...
              >
                <div
                  ...
                  @click="navigate"
                >
                  <md-icon id="nav-icon" class="explorer_page-nav-card_icon">edit_note</md-icon>
