  ...
  <div class="section_pages">
    <div v-if="!loading && !error.article" class="wrapper" key="article_loaded">
      ...
      <div class="article_metadata article_citation_count">
        Cited by <span class="article_metadata_strong">{{ article.citationCount }}</span> other
        works.
      </div>
          ...
          <table class="article_table">
            ...
            <tbody>
              <tr
                ...
                v-for="refObject of article.references.data"
                :key="refObject.paperId"
              >
        ...
        <div class="article_table">
          <table>
            ...
            <tbody>
              <tr
                class="article_table-row"
                v-for="refObject of article.citations.data"
                :key="refObject.paperId"
              >
                <td>{{ refObject.year }}</td>
                <td>{{ refObject.authorNames }}</td>
 ...
 */
const getError = (prop: string): string | boolean => {
  let base: any;
  if (prop === 'article') {
    base = article.value;
  } else {
