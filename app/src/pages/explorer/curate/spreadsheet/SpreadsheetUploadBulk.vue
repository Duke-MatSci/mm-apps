...
const submitBulkXml = (files: any) => store.dispatch('explorer/curation/submitBulkXml', files);
const clearSnackbar = () => store.commit('resetSnackbar');
const setDatasetId = (id: string) => store.commit('explorer/curation/setDatasetId', id);
...
const onInputChange = (e: Event) => {
  ...
  } else addSpreadsheet(target.files ?? []);
