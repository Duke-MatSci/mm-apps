<template>
  <div>
    ...
    <div style="width: 80%">
      ...
      smaller values result in more local data being preserved. (Default: 15)
    </div>
    <div class="u_display-flex md-layout u--layout-flex-justify-sb tool_page">
      ...
      <div class="utility-roverflow md-layout-item md-size-20">
        <md-field>
          <md-input :value="knnUmap" type="number" @change="handleKnnUmapChange"></md-input>
        </md-field>
      </div>
    </div>
  </div>
...
defineOptions({ name: 'ParamSelector' });

const store = useStore();

const ticks = ref([5, 25, 50]);
