  ...
  <div class="main tool_page">
    <div class="adjust-padding" style="margin: 5px 0 0 5px">
      <div class="viz-u-postion__rel">
        <button v-if="validateLinkProp && link" class="nuplot-button-link">
...
defineOptions({ name: 'VisualizationLayout' });
...
// Computed properties
const loading = computed(() => store.getters['metamineNU/getLoadingState']);
