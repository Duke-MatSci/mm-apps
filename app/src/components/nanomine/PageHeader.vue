<template>
  <div :style="xFlow" class="md-dense md-primary" id="reset_bg">
    <div class="md-toolbar-row viz-u-postion__rel">
      ...
      <div class="md-toolbar-section-end header_nav">
        ...
        <div class="u--inline nav_menu">
          ...
          <div v-else>
            <a class="btn btn--tertiary btn--noradius" href="/secure" id="authmenu"
              >Login/Register</a
            >
          </div>
        </div>
...
const xFlow = computed(() => {
  return { overflowX: 'clip' as const };
});
