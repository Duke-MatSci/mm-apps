...
const metamineRoutes: Array<RouteRecordRaw> = [
  ...
  // },
  {
    ...
    name: 'PairwisePlot',
    component: () =>
      import(/* webpackChunkName: "about" */ '@/pages/metamine/visualizationNU/PairwisePlot.vue'),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    name: 'Histogram',
    component: () =>
      import(/* webpackChunkName: "about" */ '@/pages/metamine/visualizationNU/HistogramPlot.vue'),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    name: 'Scatter',
    component: () =>
      import(/* webpackChunkName: "about" */ '@/pages/metamine/visualizationNU/ScatterPlot.vue'),
    meta: {
      requiresAuth: false,
    },
  },
  {
    ...
    name: 'Umap',
    component: () =>
      import(/* webpackChunkName: "about" */ '@/pages/metamine/visualizationNU/UmapPlot.vue'),
    meta: {
      requiresAuth: false,
    },
  },
